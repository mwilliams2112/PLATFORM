...
SOWFA-2.4.0()
{
  ...
  #module list
   ...
   if [ -z "$FOAM_INST_DIR" ]; then
      ...
      . /opt/openfoam240/etc/config/unset.sh
   fi
   ...
   export TESTVAR=93849
   
   foamDotFile=$FOAM_INST_DIR/openfoam240/etc/bashrc
   ...
   export SOWFA_DIR=/home/$USER/OpenFOAM/$USER-$OPENFOAM_VERSION/SOWFA-$OPENFOAM_VERSION
